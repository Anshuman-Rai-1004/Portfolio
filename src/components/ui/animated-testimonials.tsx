              ...
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <img
                    ...
                    height={500}
                    draggable={false}
                    className="h-full w-full rounded-3xl object-cover border-4 border-neutral-900"
                  />
                </motion.div>
              ))}
            </AnimatePresence>
          ...
          >
            <div className="flex gap-4 pt-12 md:pt-0">
              <div className="flex flex-col">
                <h3 className="font-bold text-2xl text-neutral-800 dark:text-neutral-200">
                  {testimonials[active].name}
                </h3>
                <p className="text-sm text-neutral-500 dark:text-neutral-400">
                  {testimonials[active].designation}
                </p>
                <motion.p className="text-lg text-neutral-600 mt-8 dark:text-neutral-300">
